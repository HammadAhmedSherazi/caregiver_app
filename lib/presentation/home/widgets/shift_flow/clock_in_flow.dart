...
class _VerifyLocationSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ShiftFlowSheetScaffold(
      ...
      subtitle: 'We confirm you\'re at the client address for EVV.',
      body: Column(
        children: [
          Container(
            width: double.infinity,
...
class _ConfirmServiceTypeSheetState extends State<_ConfirmServiceTypeSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return ShiftFlowSheetScaffold(
      title: 'Confirm service type',
      subtitle: 'Used for authorization and billing.',
      body: Column(
        children: [
      ...
      body: Column(
        children: [
          ShiftFlowDetailCard(
            child: Column(
              children: [
                ShiftFlowDetailRow(label: 'Client', value: data.clientName),
                const SizedBox(height: 12),
                ShiftFlowDetailRow(label: 'Service', value: data.serviceType),
                const SizedBox(height: 12),
                ShiftFlowDetailRow(
                  label: 'Date / Time',
                  value: visit.scheduledLabel.replaceFirst('Today · ', 'Mon · '),
                ),
                const SizedBox(height: 12),
                Row(
                  children: [
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: isSelected
                  ...
                  : AppColors.homeSheetDetailsBorder,
            ),
            boxShadow: const [
              BoxShadow(
                color: AppColors.homeCardShadow,
